...
export function getPreviewAdminData(): AdminData {
  return {
    ...
    connections: [
      ...
      { workspace_id: 'ws_ishotyouu', site_key: 'ishotyouu-demo', site_kind: 'demo', primary_domain: 'ishotyouu.leonsites.org', admin_domain: 'ishotyouu.leonsites.org', deployment_target: 'ovh:leon-platform-photographer', github_repository: null, status: 'active', current_version: 'custom-v1', last_seen_at: null, hosting_subscription_id: null, billing_mode: 'manual', desired_status: 'active', billing_state: 'manual', billing_updated_at: null, archived_at: null, archive_reason: null },
